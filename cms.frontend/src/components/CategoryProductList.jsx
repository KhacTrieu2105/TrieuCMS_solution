                ...
                <div className="list-group list-group-flush">
                    ...
                    {categoryProducts.length === 0 ? (
                        ...
                        categoryProducts.map((item) => (
                            <button
                                key={item.id}
                                type="button" className={`list-group-item list-group-item-action d-flex justify-content-between align-items-center px-4 py-3 transition-all ${selectedId === item.id ? 'bg-light font-weight-bold text-primary' : ''}`}
